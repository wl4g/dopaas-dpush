...
public class DigestUtils {
	...
	public static byte[] md2(final String data) {
		return md2(ByteBufs.toBytes(data));
	}
	...
	public static byte[] md5(final String data) {
		return md5(ByteBufs.toBytes(data));
	}
	...
	public static byte[] sha1(final String data) {
		return sha1(ByteBufs.toBytes(data));
	}
	...
	public static byte[] sha256(final String data) {
		return sha256(ByteBufs.toBytes(data));
	}
	...
	public static byte[] sha384(final String data) {
		return sha384(ByteBufs.toBytes(data));
	}
	...
	public static byte[] sha512(final String data) {
		return sha512(ByteBufs.toBytes(data));
	}
	...
	public static MessageDigest updateDigest(final MessageDigest messageDigest, final String valueToDigest) {
		messageDigest.update(ByteBufs.toBytes(valueToDigest));
		return messageDigest;
	}
